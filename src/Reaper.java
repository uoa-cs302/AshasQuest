...
public class Reaper extends Enemy {
    ...
    public Reaper(Handler handler, float x, float y, int width, int height) {
        ...
        //Movement animations
        zomDown = new Animation(350, Assets.grim_down);
        zomUp = new Animation(350, Assets.grim_up);
        zomLeft = new Animation(350, Assets.grim_left);
        zomRight = new Animation(350, Assets.grim_right);
    }
