...
public class Game extends Canvas implements Runnable{
   ...
   // private GuiScreen = screen;
    ...
    public static Game.STATE State = Game.STATE.MENU;
    ...
    public Game(){
        new Window(640,500,"Asha's Quest",this);

        //cut the next 3 lines if necessary, just present to test a particular tutorial
    ...
    //change this to public synchronized void start() in the morning
    public synchronized void start(){
        //Maybe add the below lines
        //if (isRunning)
        //return;
        isRunning = true;
    ...
    //change this to public synchronized void stop() in the morning
    public synchronized void stop(){
        //Maybe add below lines in the morning
        //if (!isRunning)
        //return;
        isRunning = false;
